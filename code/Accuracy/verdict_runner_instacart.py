...
gateway = JavaGateway.launch_gateway(classpath="C:/Users/cto/miniconda3/lib/site-packages/pyverdict/verdict_jar/verdictdb-core-0.5.9-jar-with-dependencies.jar")
...
if __name__=='__main__':
    ...
    # verdict connection
    verdict = pyverdict.postgres(host='127.0.0.1',port=5433,dbname='instacart',user='postgres',password='tlssksek1!')

    # if exist verdict tables, deelet
    verdict.sql("DROP ALL SCRAMBLE public.order_products")
    verdict.sql("DROP ALL SCRAMBLE public.orders")

    # verdic tables generation : sampling-AQP
