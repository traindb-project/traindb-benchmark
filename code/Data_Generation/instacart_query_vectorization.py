...
# conn = mariadb.connect(host='127.0.0.1',port=3306,database='instacart',user='root',password='tlssksek1!',autocommit=False)
# conn = pymysql.connect(host='127.0.0.1',port=3306,database='instacart',user='root',password='tlssksek1!',autocommit=False)
...
# cur.execute("SELECT table_name, column_name FROM information_schema.columns WHERE table_schema='instacart' ORDER BY table_name, column_name;")
# cur.execute("SELECT table_name, column_name FROM information_schema.columns WHERE table_schema='instacart' ORDER BY table_name, column_name;")
