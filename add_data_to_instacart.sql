...
copy "aisles"     from 'E:\2021-PROJECT\ML-AQP\Instacart\DATASET-INSTACART\aisles.csv'        DELIMITER ',' CSV HEADER;
copy "departments"     from 'E:\2021-PROJECT\ML-AQP\Instacart\DATASET-INSTACART\departments.csv'        DELIMITER ',' CSV HEADER;
copy "order_products"     from 'E:\2021-PROJECT\ML-AQP\Instacart\DATASET-INSTACART\/order_products__prior.csv'        DELIMITER ',' CSV HEADER;
copy "orders"     from 'E:\2021-PROJECT\ML-AQP\Instacart\DATASET-INSTACART\/orders.csv'        DELIMITER ',' CSV HEADER;
copy "products"     from 'E:\2021-PROJECT\ML-AQP\Instacart\DATASET-INSTACART\/products.csv'        DELIMITER ',' CSV HEADER;
